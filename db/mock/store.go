...
// Source: github.com/carloseabade/simple-bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.TransgerTxParams) (db.TransferTxResult, error) {
	m.ctrl.T.Helper()
